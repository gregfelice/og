...
def replay_events_to_messages(events: list[dict[str, Any]]) -> list[dict[str, Any]]:
    """Replay session events into Anthropic message format.

    Shared between SessionStore and PgSessionStore.
    """
    messages = []
    for event in events:
